...
static const uint8_t offsets[] = {0,0,0,90};
///---Colors---///
...
static const char *colors[] = {"#ffffff", "333333", "#acc267", "fb9fb1", "#ddb26f", "#ffffff", "151515"}; 
...
///--Menus and Programs---///
static const char *menucmd[] = { "dmenu_run", "-fn", "Hack:size=14", "-nb", "#282828", "-nf", "#ebdbb2", "-sb", "#282828", "-sf", "#fabd2f", NULL};
static const char *terminal[] = {"/usr/local/bin/tabbed", "-c", "-r", "2", "-g=1300x900", "st", "-w", "''", NULL};
